...
import com.example.demo.services.mappers.UserBookMapper;
...
public class UserBookServiceImpl implements UserBookService {
    ...
    public String borrowBook(long bookId) {
        ...
        else throw new CustomException("Book not available currently", HttpStatus.SERVICE_UNAVAILABLE);
    }

    @Override
    public String returnBook(long bookId) {
        long userId = facade.getAuthentication().getUserId();
        UserBook userBook = userBookRepo.findByUserIdAndBookId(userId, bookId).orElseThrow(()->new CustomException("User hasn't borrowed this book",HttpStatus.NOT_FOUND));
